...
public class PageInterceptor implements Interceptor {
    ...
    public void setProperties(Properties properties) {
    	//数据库方言设置
    	String _dialect = properties.getProperty("dialect");
    	if(StringUtils.isEmpty(_dialect)){
    		dialect = _dialect;
    	}else{
    	...
    	//正则过滤sql函数名
    	String _pageSqlId = properties.getProperty("pageSqlId");
    	if(StringUtils.isEmpty(_pageSqlId)){
    		pageSqlId = _pageSqlId;
    	}else{
